    ...
    <div class="container py-md-5">
        <div class="row align-items-center">
          <div class="col-lg-7 py-3 py-md-5">
            <h1 class="display-3">Welcome to CrustChronicles!</h1>
            <p class="lead text-muted">your go-to source for mastering the art of bread baking! Explore a world of tips and tricks that will elevate your baking skills, unravel the secrets behind the perfect crust, and turn your home kitchen into a haven for delicious, homemade bread creations. Let's embark on a journey of doughy delights together!"</p>
          </div>
